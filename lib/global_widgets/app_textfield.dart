...
import 'package:login_with_email_app/global_widgets/StringExtensions.dart';

Color greyScaleColor = const Color.fromRGBO(250, 250, 250, 1);
      ...
      child: Center(
        child: Container(
          ...
          decoration: BoxDecoration(
              color: greyScaleColor, borderRadius: BorderRadius.circular(15)),
          child: Padding(
              ...
              child: TextFormField(
                ...
                decoration: widget.decoration != null
                    ? (widget.decoration!.copyWith(
                        suffixIcon: widget.textFieldType ==
                ...
                obscuringCharacter:
                    widget.obscuringCharacter.validate(value: '•'),
